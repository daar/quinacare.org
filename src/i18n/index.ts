...
export const ui = {
  nl: {
    ...
    "news.page": "Pagina",
    "news.intro":
      "Verhalen, nieuwsbrieven en jaarverslagen van het team achter Quina Care.",
    "news.newsletters": "Nieuwsbrieven",
    "news.reports": "Jaarverslagen",
    ...
    "news.dateRange": "Periode",
    "news.from": "Van",
    "news.to": "Tot",
    "news.clear": "Wissen",
    "news.popular": "Meest populair",
    // Post
    ...
    "metrics.inpatientCareDesc":
      "Patiënten die langer onder onze zorg blijven krijgen de tijd die ze nodig hebben om te herstellen.",
    ...
    "putumayoLoop.distanceKids": "1 km (kids)",
    "putumayoLoop.distance5k": "5 km",
    "putumayoLoop.distance10k": "10 km",
    "putumayoLoop.distanceHalf": "21 km",
    "putumayoLoop.distanceFull": "42 km",
    "putumayoLoop.distanceBreakdown": "LOPERS PER AFSTAND",
  ...
  en: {
    ...
    "news.page": "Page",
    "news.intro":
      "Stories, newsletters and annual reports from the team behind Quina Care.",
    "news.newsletters": "Newsletters",
    "news.reports": "Annual reports",
    ...
    "metrics.inpatientCareDesc":
      "Patients who stay under our care get the time they need to recover.",
    ...
    "putumayoLoop.distanceHalf": "21 km",
    "putumayoLoop.distanceFull": "42 km",
    "putumayoLoop.distanceBreakdown": "RUNNERS BY DISTANCE",
  ...
  es: {
    ...
    "news.page": "Página",
    "news.intro":
      "Historias, boletines e informes anuales del equipo detrás de Quina Care.",
    "news.newsletters": "Boletines",
    "news.reports": "Informes anuales",
    ...
    "news.dateRange": "Periodo",
    "news.from": "Desde",
    "news.to": "Hasta",
    "news.clear": "Borrar",
    "news.popular": "Más populares",
    // Post
    ...
    "metrics.inpatientCareDesc":
      "Los pacientes que permanecen bajo nuestro cuidado reciben el tiempo que necesitan para recuperarse.",
    ...
    "putumayoLoop.distanceKids": "1 km (niños)",
    "putumayoLoop.distance5k": "5 km",
    "putumayoLoop.distance10k": "10 km",
    "putumayoLoop.distanceHalf": "21 km",
    "putumayoLoop.distanceFull": "42 km",
    "putumayoLoop.distanceBreakdown": "CORREDORES POR DISTANCIA",
